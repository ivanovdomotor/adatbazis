...
Insert into IVANOV.CEG (ID,NEV,FENYKEP_UT,ROVID_LEIRAS,TELEFONSZAM,EMAIL) values ('2','Nike','2_ceg.png','A Nike, Inc. vagy röviden Nike a világ els? számú edz?cip?-, sportruházat- és sportszergyártója.','06-30-578-3244','nike@citromail.hu');
Insert into IVANOV.CEG (ID,NEV,FENYKEP_UT,ROVID_LEIRAS,TELEFONSZAM,EMAIL) values ('3','Facebook','3_ceg.png','A Facebook amerikai alapítású közösségi hálózat, amely 2004. február 4-én kezdte meg m?ködését.','06-20-948-3243','alien@mars.com');
Insert into IVANOV.CEG (ID,NEV,FENYKEP_UT,ROVID_LEIRAS,TELEFONSZAM,EMAIL) values ('4','SZTE','4_ceg.png','A Szegedi Tudományegyetem (röviden: SZTE) ? Universitas Scientiarum Szegediensis / University of Szeged ? Magyarországon, Szeged városában m?köd?,  alapítvány által fenntartott fels?oktatási intézmény.','06-70-827-9125','szte@szte.hu');
Insert into IVANOV.CEG (ID,NEV,FENYKEP_UT,ROVID_LEIRAS,TELEFONSZAM,EMAIL) values ('5','Google','5_ceg.png','A Google LLC amerikai, t?zsdén bejegyzett részvénytársaság, amit eredetileg zártkör?en m?köd? társaságként alapítottak 1998-ban, és aminek a nevéhez f?z?dik a Google keres?motor kifejlesztése és üzemeltetése.','06-30-265-1958','google@yahoo.com');
...
SET DEFINE OFF;
Insert into IVANOV.HIRDETES (ID,MEGNEVEZES,MUNKAVEGZESHELYE,IDO,MUNKAREND,MUNKAFELADATLEIRAS,KOTELVARAS,OPCELVARAS,JUTTATASOK,JELENTKEZESIHATARIDO,STATUS,CEGID,ALLASHIRDETOID) values ('6','Hentes','Szeged','1','Teljes munkaid?','Szarvasmarha, juh és ló levágásával kell foglalkozni.','Hentes végzettség','Saját autó.',null,to_date('23-MÁJ.  -20','RR-MON-DD'),'1','3','2');
Insert into IVANOV.HIRDETES (ID,MEGNEVEZES,MUNKAVEGZESHELYE,IDO,MUNKAREND,MUNKAFELADATLEIRAS,KOTELVARAS,OPCELVARAS,JUTTATASOK,JELENTKEZESIHATARIDO,STATUS,CEGID,ALLASHIRDETOID) values ('1','Takarító','Szeged','1','Teljes munkaid?','Áruházak tisztítása, parkolóban felmosás.','Egyetemi diploma','Külföldi doktorandusz képzés.','Napi egyszeri étkezés.',to_date('23-MÁJ.  -19','RR-MON-DD'),'1','1','1');
Insert into IVANOV.HIRDETES (ID,MEGNEVEZES,MUNKAVEGZESHELYE,IDO,MUNKAREND,MUNKAFELADATLEIRAS,KOTELVARAS,OPCELVARAS,JUTTATASOK,JELENTKEZESIHATARIDO,STATUS,CEGID,ALLASHIRDETOID) values ('2','Programozó','Pécs','0','Teljes munkaid?','Programok írása, diszkrét matekkal foglalkozás.','Smalltalk ismerete.','Kalkulus ismerete.','Utazási költésgtérítés.',to_date('24-MÁJ.  -24','RR-MON-DD'),'1','2','2');
Insert into IVANOV.HIRDETES (ID,MEGNEVEZES,MUNKAVEGZESHELYE,IDO,MUNKAREND,MUNKAFELADATLEIRAS,KOTELVARAS,OPCELVARAS,JUTTATASOK,JELENTKEZESIHATARIDO,STATUS,CEGID,ALLASHIRDETOID) values ('3','Hegeszt?','Budapest','1','Részmunkaid?','Hegesztés megrendelések alapján.','El?zetes munkatapasztalat.',null,'Munkaegyenruha.',to_date('26-MÁJ.  -22','RR-MON-DD'),'1','3','3');
Insert into IVANOV.HIRDETES (ID,MEGNEVEZES,MUNKAVEGZESHELYE,IDO,MUNKAREND,MUNKAFELADATLEIRAS,KOTELVARAS,OPCELVARAS,JUTTATASOK,JELENTKEZESIHATARIDO,STATUS,CEGID,ALLASHIRDETOID) values ('4','Úrhajós','Szolnok','0','Részmunkaid?','?rben hajózás.','Ne félj az ?rt?l.','Ne félj a hajóktól.','A munkábajárás munkaid?nek min?sül.',to_date('22-JÚL.  -16','RR-MON-DD'),'1','4','4');
Insert into IVANOV.HIRDETES (ID,MEGNEVEZES,MUNKAVEGZESHELYE,IDO,MUNKAREND,MUNKAFELADATLEIRAS,KOTELVARAS,OPCELVARAS,JUTTATASOK,JELENTKEZESIHATARIDO,STATUS,CEGID,ALLASHIRDETOID) values ('5','Pék','Szeged','1','Teljes munkaid?','Kenyeret és cirkuszt adni a népnek.','Pék végzettség.',null,'Egyenruha és cip?.',to_date('22-AUG.  -19','RR-MON-DD'),'1','5','5');
...
Insert into IVANOV.VEGZETTSEG (ID,HELY,IDO_KEZDET,IDO_VEG,LEIRAS) values ('5','Szakképz? Centrum',to_date('20-MÁJ.  -07','RR-MON-DD'),to_date('21-MÁJ.  -07','RR-MON-DD'),'Pék végzettség');
...
Insert into IVANOV.VEGZETTSEG (ID,HELY,IDO_KEZDET,IDO_VEG,LEIRAS) values ('9','SZTE',to_date('20-MÁJ.  -15','RR-MON-DD'),to_date('21-MÁJ.  -21','RR-MON-DD'),'Programtervez? informatikus BSc');
