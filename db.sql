--------------------------------------------------------
--  File created - kedd-május-03-2022   
--------------------------------------------------------
--------------------------------------------------------
...
SET DEFINE OFF;
Insert into IVANOV.ALLASKERESO (ID,TITULUS,VEZETEKNEV,KERESZTNEV,FENYKEP_UT,SZULIDO,LAKCIM,TARTHELY,RADIUS,ONELETRAJZ_ID,ROVID_LEIRAS,EGYEB_INFO,TELEFONSZAM,EMAIL) values ('1','Dr.','Példa','Béla',null,to_date('07-MÁJ.  -16','RR-MON-DD'),'6723 Szeged, Példa utca 1.','6723 Szeged, Példa utca 1.','30',null,'Rendkívüli módon átlagos','Szeret példa lenni.','06-20-999-9999','pelda.bela@pelda.com');
...
Insert into IVANOV.CEG (ID,NEV,FENYKEP_UT,ROVID_LEIRAS,TELEFONSZAM,EMAIL) values ('2','Nike',null,'A Nike, Inc. vagy röviden Nike a világ első számú edzőcipő-, sportruházat- és sportszergyártója.','06-30-578-3244','nike@citromail.hu');
Insert into IVANOV.CEG (ID,NEV,FENYKEP_UT,ROVID_LEIRAS,TELEFONSZAM,EMAIL) values ('3','Facebook',null,'A Facebook amerikai alapítású közösségi hálózat, amely 2004. február 4-én kezdte meg működését.','06-20-948-3243','alien@mars.com');
...
Insert into IVANOV.CEG (ID,NEV,FENYKEP_UT,ROVID_LEIRAS,TELEFONSZAM,EMAIL) values ('5','Google',null,'A Google LLC amerikai, tőzsdén bejegyzett részvénytársaság, amit eredetileg zártkörűen működő társaságként alapítottak 1998-ban, és aminek a nevéhez fűződik a Google keresőmotor kifejlesztése és üzemeltetése.','06-30-265-1958','google@yahoo.com');
...
Insert into IVANOV.VEGZETTSEG (ID,HELY,IDO_KEZDET,IDO_VEG,LEIRAS) values ('3','SZTE',to_date('20-MÁJ.  -15','RR-MON-DD'),to_date('21-MÁJ.  -21','RR-MON-DD'),'Programtervező informatikus BSc');
Insert into IVANOV.VEGZETTSEG (ID,HELY,IDO_KEZDET,IDO_VEG,LEIRAS) values ('4','BME',to_date('22-JAN.  -05','RR-MON-DD'),to_date('22-MÁJ.  -02','RR-MON-DD'),'Villamosmérnök MSc');
--------------------------------------------------------
